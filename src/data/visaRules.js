...
export const VISA_TYPE_LABELS = {
  en: {
    ...
    electronic_authorization: "Electronic Authorization",
  ...
  ar: {
    ...
    electronic_authorization: "تصريح إلكتروني",
    restricted: "دخول مقيّد",
    special_permission: "تصريح خاص",
...
export const VISA_TYPE_COLORS = {
  ...
  eta: "#2980b9",
  embassy_visa: "#c9a84c",
  visa_required: "#e67e22",
  electronic_authorization: "#16a085",
  restricted: "#c0392b",
  special_permission: "#d35400",
