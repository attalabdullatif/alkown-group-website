      ...
      <section style={{ padding: "80px clamp(20px,6vw,80px)", background: "#fff" }}>
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          ...
          <div>
            ...
            {/* أرقام الهاتف مع خيار اتصال/واتساب */}
            {[
              { num: "+90 534 764 1249", call: "tel:+905347641249", wa: "https://wa.me/905347641249" },
              { num: "+971 54 490 9522", call: "tel:+971544909522", wa: "https://wa.me/971544909522" },
              { num: "+963 980 631 952", call: "tel:+963980631952", wa: "https://wa.me/963980631952" },
            ].map(({ num, call, wa }, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 14, padding: "12px 0", borderBottom: `1px solid rgba(201,168,76,.1)` }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <a href={call} style={{ background: `rgba(201,168,76,.15)`, color: C.gold, padding: "5px 12px", borderRadius: 20, fontSize: ".75rem", fontWeight: 700, textDecoration: "none", border: `1px solid rgba(201,168,76,.3)` }}>
                    {lang === "ar" ? "اتصال" : "Call"}
                  </a>
                  <a href={wa} target="_blank" rel="noreferrer" style={{ background: "rgba(37,211,102,.15)", color: "#25d366", padding: "5px 12px", borderRadius: 20, fontSize: ".75rem", fontWeight: 700, textDecoration: "none", border: "1px solid rgba(37,211,102,.3)" }}>
                    واتساب
                  </a>
                </div>
              </div>
          ...
          <div>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: 8, marginBottom: 10, alignItems: "center", flexWrap: "wrap" }}>
                ...
                <a href={call} style={{ fontSize: ".72rem", color: C.gold, textDecoration: "none", border: `1px solid ${C.gold}44`, padding: "2px 8px", borderRadius: 10 }}>اتصال</a>
                <a href={wa} target="_blank" rel="noreferrer" style={{ fontSize: ".72rem", color: "#25d366", textDecoration: "none", border: "1px solid #25d36644", padding: "2px 8px", borderRadius: 10 }}>واتساب</a>
              </div>
            ))}
