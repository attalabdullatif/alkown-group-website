...
function mapDbResult(db, nationality, residence, destination) {
  ...
  return {
    ...
    entryType: db.entry_type || null,
    passportValidityMonths: db.passport_validity_months || null,
    officialWebsite: db.official_website || null,
    sourceName: db.source_name || null,
    fromCountry,
    toCountry,
    resCountry,
